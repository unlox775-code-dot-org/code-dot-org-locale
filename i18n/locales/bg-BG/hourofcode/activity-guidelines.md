...
Code.org hosts a variety of Hour of Code™ activities, lessons, and videos on the Code.org and Hour of Code websites. Текущият списък е на адрес []({{ urls/learn }})hourofcode.com/learn.
...
*Технически изисквания:* Поради голямото разнообразие от настройки на технологиите в училище и класна стая, най-добрите дейности са уеб-базирани или удобни за смартфони или по друг начин изключен стил дейности, които преподават концепции за компютърни науки без използване на компютър (вж. http://csunplugged.com/). [](http://csunplugged.com/) Activities that require an app-install, desktop app, or game-console experiences are okay but not ideal. We will not list activities that require sign up or payment. (Robotics activities can require robotics purchase.)
