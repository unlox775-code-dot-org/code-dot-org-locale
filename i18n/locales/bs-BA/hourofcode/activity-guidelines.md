...
Code.org hosts a variety of Hour of Code™ activities, lessons, and videos on the Code.org and Hour of Code websites. Trenutna lista je na []({{ urls/learn }})hourofcode.com/learn.
...
*Tehnički zahtjevi:* Zbog širokog spektra postavki školske i učionice, najbolje su aktivnosti zasnovane na webu ili pametnim telefonima ili na drugi način unplugged-style aktivnosti koje podučavaju koncepte informatike bez upotrebe računara (vidi http://csunplugged.com/). [](http://csunplugged.com/) Activities that require an app-install, desktop app, or game-console experiences are okay but not ideal. We will not list activities that require sign up or payment. (Robotics activities can require robotics purchase.)
