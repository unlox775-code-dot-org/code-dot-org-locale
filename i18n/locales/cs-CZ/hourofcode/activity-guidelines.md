...
Code.org hosts a variety of Hour of Code™ activities, lessons, and videos on the Code.org and Hour of Code websites. Aktuální seznam je na adrese []({{ urls/learn }})hourofcode.com/learn.
...
*Technické požadavky:* Vzhledem k široké škále nastavení školních a třídních technologií jsou nejlepšími aktivitami webové nebo chytré telefony nebo činnosti v jiném odpojeném stylu, které učí koncepty informatiky bez použití počítače (viz http://csunplugged.com/). [](http://csunplugged.com/) Activities that require an app-install, desktop app, or game-console experiences are okay but not ideal. We will not list activities that require sign up or payment. (Robotics activities can require robotics purchase.)
