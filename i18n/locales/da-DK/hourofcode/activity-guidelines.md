...
Code.org hosts a variety of Hour of Code™ activities, lessons, and videos on the Code.org and Hour of Code websites. Den aktuelle liste findes på []({{ urls/learn }})hourofcode.com/learn.
...
*Tekniske krav:* På grund af den brede vifte af skole- og klasseværelsesteknologiopsætninger er de bedste aktiviteter webbaserede eller smartphone-venlige eller på anden måde ikke-tilsluttede aktiviteter, der underviser i datalogiske koncepter uden brug af en computer (se http://csunplugged.com/). [](http://csunplugged.com/) Activities that require an app-install, desktop app, or game-console experiences are okay but not ideal. We will not list activities that require sign up or payment. (Robotics activities can require robotics purchase.)
