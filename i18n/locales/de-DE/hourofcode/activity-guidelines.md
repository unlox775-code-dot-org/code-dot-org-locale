...
Code.org hosts a variety of Hour of Code™ activities, lessons, and videos on the Code.org and Hour of Code websites. Die aktuelle Liste befindet sich unter []({{ urls/learn }})hourofcode.com/learn.
...
*Technische Anforderungen:* Aufgrund der großen Vielfalt an Technologien für Schulen und Klassenzimmer eignen sich am besten Aktivitäten webbasierte oder Smartphone-freundliche oder anderweitig unplugged-ähnliche Aktivitäten, bei denen Informatikkonzepte ohne den Einsatz eines Computers vermittelt werden (siehe http://csunplugged.com/). [](http://csunplugged.com/) Activities that require an app-install, desktop app, or game-console experiences are okay but not ideal. We will not list activities that require sign up or payment. (Robotics activities can require robotics purchase.)

*Von Schülern geleitetes (selbstgeführtes) Format:* Die ursprüngliche Hour of Code basierte hauptsächlich auf dem Erfolg von selbstgesteuerten Tutorials oder Lektionen, die optional vom Lehrer moderiert wurden. There are plenty of existing options, but if you want to create a new one, these activities should be designed so they can be fun for a student working alone, or in a classroom whose teacher has minimal prep or CS background. They should provide directions for students as opposed to an open-ended hour-long challenge. Ideally, the instructions and tutorials are integrated directly into the programming platform, to avoid switching tabs or windows between the tutorial and the programming platform.
...
* Upon finishing your activity, users should be directed to [code.org/api/hour/finish](https://code.org/api/hour/finish) where they will be able to: 
    ...
    * Für Nutzer, die eine Stunde mit Ihrer Aktivität verbringen und sie nicht abschließen, fügen Sie Ihrer Aktivität bitte eine Schaltfläche mit der Aufschrift „Ich bin fertig mit meiner Hour of Code“ hinzu, die auch zu [](https://code.org/api/hour/finish) code.org/api/hour/finish zurückführt.
...
**Stellen Sie sicher, dass Ihr Tutorial in einem [Pair Programming](http://www.ncwit.org/resources/pair-programming-box-power-collaborative-learning) Paradigma verwendet werden kann.** Dies ist besonders nützlich für die Hour of Code, da in vielen Klassenzimmern keine 1:1 -Hardware für alle Schüler verfügbar ist.
...
- Weitere Informationen finden Sie in unserem [Resource Kit](https://hourofcode.com/us/promote) .
