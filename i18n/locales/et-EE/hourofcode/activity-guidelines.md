...
Code.org hosts a variety of Hour of Code™ activities, lessons, and videos on the Code.org and Hour of Code websites. Praegune nimekiri on aadressil []({{ urls/learn }})hourofcode.com/learn.
...
*Tehnilised nõuded:* Kuna kooli- ja klassiruumi tehnoloogia seadistused on väga erinevad, on parimad tegevused veebipõhised või nutitelefonisõbralikud või muul viisil unplugged-stiilis tegevused, mis õpetavad arvutiteaduse mõisteid ilma arvuti kasutamiseta (vt http://csunplugged.com/). [](http://csunplugged.com/) Activities that require an app-install, desktop app, or game-console experiences are okay but not ideal. We will not list activities that require sign up or payment. (Robotics activities can require robotics purchase.)
