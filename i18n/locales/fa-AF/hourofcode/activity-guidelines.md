...
*الزامات فنی: از* آنجا که از طیف گسترده ای از مدرسه و کلاس درس راه اندازی فن آوری، بهترین فعالیت های مبتنی بر وب و یا گوشی های هوشمند پسند، و یا فعالیت های غیر این صورت جدا سبک است که آموزش مفاهیم علوم کامپیوتر بدون استفاده از یک کامپیوتر (نگاه کنید به http://csunplugged.com/). [](http://csunplugged.com/) Activities that require an app-install, desktop app, or game-console experiences are okay but not ideal. We will not list activities that require sign up or payment. (Robotics activities can require robotics purchase.)
...
* پس از اتمام فعالیت خود، کاربران باید به [](https://code.org/api/hour/finish) code.org/api/hour/finish هدایت شوند، جایی که آنها قادر خواهند بود: 
    * Share on social media that they completed the Hour of Code
    * Receive a certificate that they completed the Hour of Code
    * See leaderboards about which countries/cities have the highest participation rates in Hour of Code activities
    * برای کاربرانی که یک ساعت در فعالیت خود را صرف و آن را کامل نیست، لطفا یک دکمه در فعالیت خود را که می گوید «من با ساعت من از کد به پایان رسید» که لینک به [](https://code.org/api/hour/finish) code.org/api/hour/finish نیز هست.
