...
Code.org hosts a variety of Hour of Code™ activities, lessons, and videos on the Code.org and Hour of Code websites. הרשימה הנוכחית נמצאת בכתובת []({{ urls/learn }})hourofcode.com/ללמוד.
...
**פאזל או משחק בהדרכה עצמית ([דוגמה](https://code.org/dance))**
...
*דרישות טכניות:* בגלל המגוון הרחב של הגדרות טכנולוגיות בית ספר וכיתות, הפעילויות הטובות ביותר הן מבוססות אינטרנט או ידידותיות לסמארטפון, או פעילויות בסגנון מנותק אחר המלמדות מושגי מדעי המחשב ללא שימוש במחשב (ראה http://csunplugged.com/). [](http://csunplugged.com/) Activities that require an app-install, desktop app, or game-console experiences are okay but not ideal. We will not list activities that require sign up or payment. (Robotics activities can require robotics purchase.)
...
* עם סיום הפעילות שלך, המשתמשים צריכים להיות מופנים אל [](https://code.org/api/hour/finish) code.org/api/שעה/סיום שבו הם יוכלו: 
    * Share on social media that they completed the Hour of Code
    * Receive a certificate that they completed the Hour of Code
    * See leaderboards about which countries/cities have the highest participation rates in Hour of Code activities
    * למשתמשים שמבלים שעה בפעילות שלך ולא משלימים אותה, אנא כלול כפתור בפעילות שלך שאומר "סיימתי עם שעת הקוד שלי" המקשר חזרה גם ל- [](https://code.org/api/hour/finish) code.org/api/hour/finish.
