---
title: Kódolás órája útmutató vállalatok számára
---

{{ signup_button }}

# Hogyan vehet részt a vállalata a Kódolás órájában

### Ismerje meg, hogyan inspirálhatja Ön és alkalmazottai a diákokat arra, hogy kipróbálják a számítástechnikát!
...
A Kódolás órája kampány során cége segíthet felhívni a figyelmet a számítástechnikai mozgalomra. Akár egyéni önkéntesként dolgozik, akár a vállalata számára szervez egy rendezvényt, a munkájával nagy mértékben befolyásolhatja azt, hogy marginalizált faji és etnikai csoportokhoz tartozó fiatal nők és diákok hogyan látják az informatikát és a saját lehetőségeiket.
...
<h4><font color="00adbc"><i>„Imádtam látni, hogy mennyire izgatottak voltak a gyerekek. Az egyik csodálatos dolog az volt, amikor a tanárok észrevették, hogy vannak olyan diákok, akiknek nem megy jól az elmélet, de kiválóan működnek fejlesztőként és segíteni tudnak másoknak - így kaptak egy helyet, ahol magabiztosan mozoghattak.”</i></font></h4>

- Önkéntes a Kódolás óráján

* * *

<a id="host-hour-of-code"></a>

## Szervezzen egy saját Kódolás órája eseményt

Ha még többet szeretne tenni, legyen az Ön vállalata házigazdája egy Kódolás órája eseménynek. Egy esemény megrendezésére vonatkozóan nincs semmilyen előírásunk, ezért arra bátorítjuk, hogy legyen kreatív! Tekintettel arra, hogy Code.org kevés (de nagyon lelkes!) munkatárssal dolgozik, nincs olyan csoportunk, amelyik a Kódolás órája rendezvények koordinálásával foglalkozna. Van azonban néhány ötletünk a kezdéshez.
...
- Oszd meg a Kódolás Órája-hoz kapcsolódó fotóidat, videóidat a közösségi hálón. Használd a következőket: [#HourOfCode](https://twitter.com/hashtag/hourofcode) and [@codeorg](https://twitter.com/codeorg) Így mi is felhívhatjuk a figyelmet a sikereitekre!
