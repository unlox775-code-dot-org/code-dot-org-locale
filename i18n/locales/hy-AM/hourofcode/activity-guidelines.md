...
Code.org hosts a variety of Hour of Code™ activities, lessons, and videos on the Code.org and Hour of Code websites. Ընթացիկ ցուցակը գտնվում է []({{ urls/learn }})hourofcode.com/learn.
...
**Ինքնակառավարման առաջնորդվում հանելուկ կամ խաղ (օրինակ)[](https://code.org/dance)**
...
**Ուսուցիչը Դյուրացված դաս ([օրինակ](https://studio.code.org/s/course1/lessons/2/levels/1), Կաղապար [)](https://docs.google.com/document/d/1DhaLNd6uim9rRPkHrglnOvVcgzGc8axKIzv8YI56JGA)**
...
*Տեխնիկական պահանջներ. Դպրոցական և դասարանների տեխնոլոգիական կայանքների լայն բազմազանության* պատճառով լավագույն գործողություններն են վեբ վրա հիմնված կամ սմարթֆոնների համար հարմար, կամ այլ կերպ անջատված ոճի գործողություններ, որոնք համակարգչային գիտության հասկացություններ են սովորեցնում առանց համակարգչի օգտագործման (տես http://csunplugged.com/): [](http://csunplugged.com/) Activities that require an app-install, desktop app, or game-console experiences are okay but not ideal. We will not list activities that require sign up or payment. (Robotics activities can require robotics purchase.)
...
To ստանալ զգացում լայն տեսակի ճանապարհները եւ դասի պլանների դուք կարող եք ստեղծել, այցելեք [Hour of Code Գործունեության էջ.](https://hourofcode.com/us/learn)
...
* Ձեր գործունեությունը ավարտելուց հետո օգտվողները պետք է ուղղված լինեն [](https://code.org/api/hour/finish) code.org/api/ժամ/ավարտի, որտեղ նրանք կկարողանան. 
    * Share on social media that they completed the Hour of Code
    * Receive a certificate that they completed the Hour of Code
    * See leaderboards about which countries/cities have the highest participation rates in Hour of Code activities
    * Օգտագործողների համար, ովքեր մեկ ժամ են ծախսում ձեր գործունեության վրա և չեն ավարտում այն, խնդրում ենք ներառել ձեր գործունեության կոճակը, որն ասում է. “Ես ավարտեցի իմ օրենսգրքի ժամը”, որը կապում է նաև [](https://code.org/api/hour/finish) code.org/api/hour/finish- ին:
...
IMG ՊԵԿ = http://code.org/api/hour/begin_dance.png [](http://code.org/api/hour/begin_dance.png)   
