...
Code.org hosts a variety of Hour of Code™ activities, lessons, and videos on the Code.org and Hour of Code websites. Daftar saat ini ada di []({{ urls/learn }})hourofcode.com/learn.
...
*Persyaratan teknis:* Karena berbagai macam pengaturan teknologi sekolah dan kelas, kegiatan terbaik adalah berbasis Web atau ramah ponsel cerdas, atau kegiatan gaya unplugged-style yang mengajarkan konsep ilmu komputer tanpa menggunakan komputer (lihat http://csunplugged.com/). [](http://csunplugged.com/) Activities that require an app-install, desktop app, or game-console experiences are okay but not ideal. We will not list activities that require sign up or payment. (Robotics activities can require robotics purchase.)
