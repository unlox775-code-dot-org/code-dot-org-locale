...
- [1日の予定を作成する](#create-your-plan)
- [Promote your Hour of Code](#promote-your-hour)
- [Hour of Code イベントの開始方法](#how-to-start)
- [プログラミングを実施する](#code)
- [生徒の成功を祝う](#celebrate)
...
あなたや生徒がコンピューターサイエンスに不慣れであっても問題ありません。ここではHour of Codeアクティビティを紹介するアイデアをいくつか紹介します。
...
- 女子にコンピュータサイエンスに対する興味を持ってもらうヒントは [こちら]({{ urls/girls }})をご覧ください。
