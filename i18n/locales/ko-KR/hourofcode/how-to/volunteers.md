...
컴퓨팅적 사고는 문제해결 능력과 논리력, 창의력을 키워주는데 도움이 됩니다. 테크놀로지는 지구상의 모든 산업을 변모시키고 있습니다. 오늘날 학생은 단순히 사용법만이 아닌 기술을 창조하는 방법을 배워야 합니다.

아워오브코드는 "코드"를 이해하기 쉽게 해주며 누구나 기초를 배울 수 있음을 보여주고, 컴퓨터 과학 분야의 참여를 넓히도록 설계된 한 시간 분량의 컴퓨터 과학 입문 과정입니다. 컴퓨터 과학 운동의 인식을 제고하는데 도움을 줄 수 있으며, 더 많은 학생들 특히 오랜 시간 소외된 인종 및 민족 그룹의 어린 여성과 학생에게 컴퓨터 과학을 배우도록 영감을 줄 수 있습니다.

- [자원봉사는 어떤 사람이 할 수 있나요?](#who-can-volunteer)
- [자원봉사는 왜 해야 하나요?](#why-volunteer)
...
자원봉사를 가상 또는 대면으로 하든 또는 회사와 함께 하든, 여러분의 모든 노력은 컴퓨터 과학과 학생들의 잠재력을 바라보는 방식에 엄청난 영향을 미칠 수 있습니다. 여전히 궁금한 점이 있으시면 [자원봉사자 툴키트를 살펴 보십시오]({{ localized_files/hoc_volunteer_toolkit }}).

* * *

<a id="who-can-volunteer"></a>

## 자원봉사는 어떤 사람이 할 수 있나요?

컴퓨터 과학 교육과 기술부문 내 다양성 증진에 열정을 가진 분이라면 누구나 자원봉사자가 될 수 있습니다! 다양한 배경의 자원 봉사자가 참여하길 기대합니다. 아워오브코드는 모든 연령과 기량 레벨에 맞게 다양한 활동으로 구성되어 있으므로, 자원봉사자가 프로그래밍 전문가일 필요는 없습니다!

교실에서 초빙 강사가 되거나 또는 교사를 도와 활동을 지도할 수 있습니다. [지금 신청](https://code.org/volunteer)하여 학생들이 계속 컴퓨터 과학을 공부하도록 격려해 주세요.
...
컴퓨터 과학은 21세기의 중요한 분야이지만 대부분의 학교는 여전히 이 학문을 가르치고 있지 않습니다. 이러한 학생들에게는 한 번의 아워오브코드가 일 년내내 통틀어 컴퓨터 과학을 접할 수 있는 최고의 기회일 수 있습니다. 여러분의 자원봉사로 CS를 학과 과정으로 편입시키려는 교사들의 노력이 훨씬 줄어들 수 있습니다. 

[![](/images/fit-600/Marketing/HoC-2015-ACE-HS--42.jpg)]({{ urls/learn }})

이전의 자원봉사자들이 하는 이야기를 확인해 보세요:

- "내 경험에서 최고의 부분은 전체 학급이 여성과 유색인종으로 구성되었다는 겁니다. 다시 말해서, 이 아이들에게 다가가 재미있게 해 줄 기회가 생겼다는 의미인거죠"
...
교사들이 저희의 [자원봉사자 맵](http://code.org/volunteer/local)에서 자원봉사자를 검색할 수 있습니다. 신청인이 교실 인근에 있으면, 교사가 맵에서 신청인의 프로필을 검토할 것이므로, 신청인은 가능한 자세한 내용을 기재하여 교사가 연락할 확률을 높일 수 있습니다.

[![](/images/fit-600/Marketing/2018_HoC-489-resized.jpg)]({{ urls/learn }})

결정되면, 교사가 플랫폼을 통해 연락합니다 (당사는 교사와 신청인의 이메일 주소를 공유하지 않습니다). 신청인이 이벤트에 어떻게 기여할지, 또한 직접 방문하여 봉사할지 또는 가상적으로 봉사할지 함께 결정하십시오.
...
- 이벤트에서의 역할 기술부문에서 일하고 있으면 가령 어떻게 기술부문에서 일을 하게 되었는지 등, 개인적인 경험 또는 이야기를 해달라는 요청을 받을 수 있습니다. 컴퓨터 과학이 왜 귀하에게 중요합니까? 업무의 일부로 어떤 일을 하고 있으며 그것이 기술과 어떻게 관련이 있습니까?
...
- 가상적으로 자원봉사를 하려면, 교사와 함께 이벤트를 테스트해보고 사용할 최고의 화상회의 플랫폼을 결정하세요. 
- 교사가 이미 이벤트에 대한 아워오브코드 활동을 결정해 놓았으면, 미리 그것을 [탐구](https://hourofcode.com/us/learn) 할 수 있다는 점을 알아두세요.

### 참여자에 대해 생각하세요.

- 말할 대상이 되는 학생들이 누구이며 무엇이 그들의 반향을 얻을 수 있는지 생각해 보십시오. 자원봉사자로서 학생들에게 컴퓨터는 어디에서나 사용되고 있고, 학생들 역시 컴퓨터 과학자가 될 수도 있음을 깨닫도록 도와줄 수 있습니다. 연령과 배경, 성 정체성을 고려하고 그들의 관심사에 부합할 수 있는 주제를 준비합니다. 여기 [어린 여학생](http://code.org/girls)이 참여하도록 영감을 주는 방법에 대한 추가적인 안내가 있습니다.
- 학생들이 재미있어 하도록 만들어보세요! 학생들이 학습에 집중하고 흥미진진하게 아워오브코드를 할 수 있도록 [영감을 주는 동영상](https://hourofcode.com/us/promote/resources#videos)을 교사와 함께 선택하세요.
- 가상 자원봉사자이면, 학생들이 계속 집중할 수 있게 프레젠테이션의 일부로 몇 개의 슬라이드를 만드는 방안도 고려하세요. 
...
### 아직 교사의 연락을 받지 못했습니다. 어떻게 하면 자원봉사를 할 수 있습니까?
