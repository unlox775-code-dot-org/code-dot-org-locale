...
Code.org hosts a variety of Hour of Code™ activities, lessons, and videos on the Code.org and Hour of Code websites. Pašreizējais saraksts ir vietnē []({{ urls/learn }})hourofcode.com/learn.
...
*Tehniskās prasības: Skolas un klases tehnoloģiju iestatījumu daudzveidības* dēļ labākās darbības ir tīmeklī vai viedtālrunī draudzīgas vai citādi atvienotas darbības, kas māca datorzinātnes koncepcijas, neizmantojot datoru (sk. http://csunplugged.com/). [](http://csunplugged.com/) Activities that require an app-install, desktop app, or game-console experiences are okay but not ideal. We will not list activities that require sign up or payment. (Robotics activities can require robotics purchase.)
