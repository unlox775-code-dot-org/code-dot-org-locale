...
Code.org hosts a variety of Hour of Code™ activities, lessons, and videos on the Code.org and Hour of Code websites. Тековната листа е на []({{ urls/learn }})hourofcode.com/learn.
...
**Наставник олеснета лекција ([пример](https://studio.code.org/s/course1/lessons/2/levels/1), [дефиниција](https://docs.google.com/document/d/1DhaLNd6uim9rRPkHrglnOvVcgzGc8axKIzv8YI56JGA))**
...
*Технички барања:* Поради широк спектар на училиште и училница технологија поставувања, најдобрите активности се веб-базирани или паметен телефон-пријателски, или на друг начин исклучен стил активности кои учат компјутерски науки концепти без употреба на компјутер (види http://csunplugged.com/). [](http://csunplugged.com/) Activities that require an app-install, desktop app, or game-console experiences are okay but not ideal. We will not list activities that require sign up or payment. (Robotics activities can require robotics purchase.)
...
* По завршувањето на вашата активност, корисниците треба да бидат насочени кон [](https://code.org/api/hour/finish) code.org/api/час/финиш каде што ќе можат: 
    * Share on social media that they completed the Hour of Code
    * Receive a certificate that they completed the Hour of Code
    * See leaderboards about which countries/cities have the highest participation rates in Hour of Code activities
    * За корисниците кои поминуваат еден час на вашата активност и не ја завршуваат, ве молиме вклучете копче на вашата активност на кое пишува “Јас сум завршил со мојот час на кодот” што поврзува назад кон [](https://code.org/api/hour/finish) code.org/api/hour/finish, како и.
...
ИМГ СРЦ = http://code.org/api/hour/begin_dance.png [](http://code.org/api/hour/begin_dance.png)   
