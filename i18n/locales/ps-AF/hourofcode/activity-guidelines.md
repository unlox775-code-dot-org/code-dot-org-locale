...
Code.org hosts a variety of Hour of Code™ activities, lessons, and videos on the Code.org and Hour of Code websites. اوسنی لیست په [hourofcode.com/learn]({{ urls/learn }})کې دی.
...
*تخنیکي اړتیاوې: د ښوونځي او ټولګي ټیکنالوژۍ تنظیماتو پراخه ډولونو له* امله، غوره فعالیتونه د ویب پراساس یا سمارټ فون دوستانه دي، یا بل ډول غیر منظم سټایل فعالیتونه چې د کمپیوټر کارولو پرته د کمپیوټر ساینس مفهومونه درس ورکوي (وګورئ http://csunplugged.com/). [](http://csunplugged.com/) Activities that require an app-install, desktop app, or game-console experiences are okay but not ideal. We will not list activities that require sign up or payment. (Robotics activities can require robotics purchase.)
...
* ستاسو د فعالیت پای ته رسیدو سره، کاروونکي باید [](https://code.org/api/hour/finish) code.org/api/ساعت/پای ته واستول شي چیرې چې دوی به وکولی شي: 
    * Share on social media that they completed the Hour of Code
    * Receive a certificate that they completed the Hour of Code
    * See leaderboards about which countries/cities have the highest participation rates in Hour of Code activities
    * د کاروونکو لپاره چې ستاسو په فعالیت کې یو ساعت تیروي او دا بشپړ نه کوي، مهرباني وکړئ په خپل فعالیت کې یوه ت buttonۍ شامله کړئ چې وايي «زه زما د کوډ ساعت سره پای ته رسیدلی یم» کوم چې بیرته [](https://code.org/api/hour/finish) code.org/api/hour/پای سره تړاو لري.
