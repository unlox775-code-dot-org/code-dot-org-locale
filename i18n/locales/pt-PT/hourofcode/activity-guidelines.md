---
title: Diretrizes de atividades
---
...
Code.org hosts a variety of Hour of Code™ activities, lessons, and videos on the Code.org and Hour of Code websites. A lista atual está em []({{ urls/learn }})hourofcode.com/learn.
...
**Quebra-cabeça ou jogo autoguiado ([exemplo](https://code.org/dance))**
...
**Aula facilitada pelo professor ([exemplo](https://studio.code.org/s/course1/lessons/2/levels/1), [modelo](https://docs.google.com/document/d/1DhaLNd6uim9rRPkHrglnOvVcgzGc8axKIzv8YI56JGA))**
...
*Requisitos técnicos:* devido à grande variedade de configurações de tecnologia escolar e de sala de aula, as melhores atividades são atividades baseadas na Web, compatíveis com smartphones ou desconectadas, que ensinam conceitos de ciência da computação sem o uso de um computador (consulte http://csunplugged.com/). [](http://csunplugged.com/) Activities that require an app-install, desktop app, or game-console experiences are okay but not ideal. We will not list activities that require sign up or payment. (Robotics activities can require robotics purchase.)
...
Para ter uma ideia da grande variedade de tipos de tutoriais e planos de aula que você pode criar, visite a página de atividades da [Hora do Código.](https://hourofcode.com/us/learn)
...
* Ao finalizar sua atividade, os usuários devem ser direcionados para [code.org/api/hour/finish](https://code.org/api/hour/finish) , onde poderão: 
    * Share on social media that they completed the Hour of Code
    * Receive a certificate that they completed the Hour of Code
    * See leaderboards about which countries/cities have the highest participation rates in Hour of Code activities
    * Para usuários que passam uma hora em sua atividade e não a concluem, inclua um botão em sua atividade que diga “Concluí minha Hora do Código”, com links para [](https://code.org/api/hour/finish) code.org/api/hour/finish.
...
4. Include language on the page (or in the footer), including links to the Hour of Code, CSEdWeek and Code.org web sites, that discloses both the following: a. Hour of Code® and Hora del Código® are registered trademarks of Code.org; and b. “A '[Hora do Código](http://hourofcode.com/) ® é uma iniciativa nacional da [Code.org](http://code.org/) para apresentar a milhões de estudantes uma hora de ciência da computação e programação de computadores.”
