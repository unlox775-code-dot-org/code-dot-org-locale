...
Code.org hosts a variety of Hour of Code™ activities, lessons, and videos on the Code.org and Hour of Code websites. Текущий список можно найти по адресу [hourofcode.com/learn]({{ urls/learn }}).
...
*Технические требования:* поскольку в школах и классах используются самые разные технологии, лучше всего использовать занятия, адаптированные к Интернету, смартфонам или иным образом не подключенные к сети, в которых изучаются основы информатики без использования компьютера (см. http://csunplugged.com/). [](http://csunplugged.com/) Activities that require an app-install, desktop app, or game-console experiences are okay but not ideal. We will not list activities that require sign up or payment. (Robotics activities can require robotics purchase.)
...
**Поощряйте учащихся публиковать сообщения в социальных сетях (при необходимости) по окончании обучения.** Например: «Я провел час кода вместе с ________ Have you? #HourOfCode” or “I’ve done an #HourOfCode as a part of #CSEdWeek. Have you? @Scratch.” Use the hashtag **#HourOfCode** (with capital letters H, O, C)
