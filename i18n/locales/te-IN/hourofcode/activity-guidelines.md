...
Code.org hosts a variety of Hour of Code™ activities, lessons, and videos on the Code.org and Hour of Code websites. ప్రస్తుత జాబితా []({{ urls/learn }})hourofcode.com/learn వద్ద ఉంది.
...
**స్వీయ-గైడెడ్ పజిల్ లేదా ఆట (ఉదాహరణ)[](https://code.org/dance)**
...
*సాంకేతిక అవసరాలు: అనేక రకాల పాఠశాల మరియు తరగతి గది సాంకేతిక సెటప్ల* కారణంగా, ఉత్తమ కార్యకలాపాలు వెబ్ ఆధారిత లేదా స్మార్ట్ఫోన్-స్నేహపూర్వక, లేదా కంప్యూటర్ ఉపయోగించకుండా కంప్యూటర్ సైన్స్ భావనలను నేర్పించే ప్లగ్-శైలి కార్యకలాపాలు (చూడండి http://csunplugged.com/). [](http://csunplugged.com/) Activities that require an app-install, desktop app, or game-console experiences are okay but not ideal. We will not list activities that require sign up or payment. (Robotics activities can require robotics purchase.)
...
* మీ కార్యాచరణను పూర్తి చేసిన తర్వాత, వినియోగదారులు [కోడ్.org/api/hour/finish కు దర్శకత్వం వహించాలి, అక్కడ వారు చేయగలరు](https://code.org/api/hour/finish) : 
    * Share on social media that they completed the Hour of Code
    * Receive a certificate that they completed the Hour of Code
    * See leaderboards about which countries/cities have the highest participation rates in Hour of Code activities
    * మీ కార్యాచరణకు ఒక గంట గడిపిన మరియు దాన్ని పూర్తి చేయని వినియోగదారుల కోసం, దయచేసి మీ కార్యాచరణపై “నేను నా అవర్ కోడ్తో పూర్తి అయ్యాను” అని చెప్పే బటన్ను చేర్చండి, ఇది [](https://code.org/api/hour/finish) కోడ్.org/api/hour/finish కి తిరిగి లింక్ చేస్తుంది.
