...
Code.org hosts a variety of Hour of Code™ activities, lessons, and videos on the Code.org and Hour of Code websites. Поточний список знаходиться на сайті [hourofcode.com/learn]({{ urls/learn }}).
...
*Технічні вимоги:* Через велику різноманітність шкільних та класних технологій найкращими видами діяльності є веб-сайти або смартфони, або інші заходи в стилі без підключення, які викладають концепції інформатики без використання комп'ютера (див. http://csunplugged.com/). [](http://csunplugged.com/) Activities that require an app-install, desktop app, or game-console experiences are okay but not ideal. We will not list activities that require sign up or payment. (Robotics activities can require robotics purchase.)
...
* Після завершення вашої діяльності користувачі повинні бути спрямовані на [](https://code.org/api/hour/finish) code.org/api/hour/finish, де вони зможуть: 
    * Share on social media that they completed the Hour of Code
    * Receive a certificate that they completed the Hour of Code
    * See leaderboards about which countries/cities have the highest participation rates in Hour of Code activities
    * Для користувачів, які витрачають годину на вашу діяльність і не завершують її, будь ласка, додайте кнопку на вашій діяльності з написом «Я закінчив свою годину коду», яка також посилається на [](https://code.org/api/hour/finish) code.org/api/hour/finish.
