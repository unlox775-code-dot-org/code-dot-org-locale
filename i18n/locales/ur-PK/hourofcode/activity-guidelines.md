...
Code.org hosts a variety of Hour of Code™ activities, lessons, and videos on the Code.org and Hour of Code websites. موجودہ فہرست []({{ urls/learn }})hourofcode.com/سیکھنے پر ہے.
...
آپ اپنے سبق کی منصوبہ بندی کے</a> لئے اس سانچے کے ساتھ شروع کر سکتے ہیں.</p> 
...
*تکنیکی ضروریات: اسکول اور کلاس روم ٹیکنالوجی کی وسیع اقسام کے سیٹ اپ کی* وجہ سے، بہترین سرگرمیاں ویب پر مبنی یا اسمارٹ فون دوستانہ، یا دوسری صورت میں ان پلگ شدہ طرز کی سرگرمیاں ہیں جو کمپیوٹر کے استعمال کے بغیر کمپیوٹر سائنس کے تصورات کو سکھاتی ہیں (دیکھیں http://csunplugged.com/) ۔ [](http://csunplugged.com/) Activities that require an app-install, desktop app, or game-console experiences are okay but not ideal. We will not list activities that require sign up or payment. (Robotics activities can require robotics purchase.)
...
[گھنٹہ کوڈ™ سرگرمی اور AI جمع کرانے کے صفحے پر](https://docs.google.com/forms/d/e/1FAIpQLSdsdTKU6pD5qXlPUQWlgrjESRlm2L02wkTcZQuL8hz9OEvzNQ/viewform) جائیں اور اپنی سرگرمی جمع کرانے کے لیے سوالات مکمل کریں۔
...
* Upon finishing your activity, users should be directed to [code.org/api/hour/finish](https://code.org/api/hour/finish) where they will be able to: 
    ...
    * صارفین کے لئے جو آپ کی سرگرمی پر ایک گھنٹہ خرچ کرتے ہیں اور اسے مکمل نہیں کرتے ہیں، برائے مہربانی آپ کی سرگرمی پر ایک بٹن شامل کریں جو کہتا ہے کہ “میں اپنے گھنٹہ کوڈ کے ساتھ ختم ہوگیا ہوں” جو [](https://code.org/api/hour/finish) code.org/api/hour finish پر واپس لنکس کرتا ہے.
...
**Encourage students to post to social media (where appropriate) when they've finished.** For example “I’ve done an Hour of Code with ________ Have you? #HourOfCode” or “I’ve done an #HourOfCode as a part of #CSEdWeek. Have you? @Scratch.” ہیش ٹیگ **#HourOfCode کا استعمال کریں** (دارالحکومت حروف H، O، C کے ساتھ)
...
آئی ایم جی ایس آر سی = http://code.org/api/hour/begin_dance.png [](http://code.org/api/hour/begin_dance.png)   
