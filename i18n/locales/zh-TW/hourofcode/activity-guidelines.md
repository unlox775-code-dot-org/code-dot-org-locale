...
Code.org hosts a variety of Hour of Code™ activities, lessons, and videos on the Code.org and Hour of Code websites. 目前的清單位於學 [習]({{ urls/learn }})。
...
*技術要求：* 由於學校和教室的技術設置種類繁多，因此最好的活動是基於 Web 或智能手機友好的，或者不使用計算機即可教授計算機科學概念的其他未插拔式活動（見 http://csunplugged.com/）。 [](http://csunplugged.com/) Activities that require an app-install, desktop app, or game-console experiences are okay but not ideal. We will not list activities that require sign up or payment. (Robotics activities can require robotics purchase.)
...
- Feature Hour of Code and CSEdWeek on your website. 例如： <http://www.tynker.com/hour-of-code>
